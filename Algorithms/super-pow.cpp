...
#include <iterator>
using namespace std;
// BEGIN: https://discuss.leetcode.com/topic/50489/c-clean-and-short-solution
class Solution {
public:
	int superPow(int a, vector<int>& b) {
		...
		b.pop_back();
		const int n = 1337;
		return helper(superPow(a, b), 10) * helper(a, x) % n;
	}
private:
...
// END: https://discuss.leetcode.com/topic/50489/c-clean-and-short-solution
...
int main(void) {
	Solution solution;
	vector<int> b = {3};
	cout << solution.superPow(2, b) << "\tPassed\n";
	b = {1, 0};
	cout << solution.superPow(2, b) << "\tPassed\n";
	b = {1, 0, 0};
	cout << solution.superPow(20, b) << "\tPassed\n";
	...
	// cout << solution.superPow(78267, b) << "\tPassed\n";
	cout << "\nPassed All\n";
	return 0;
}